...
**before** | Option<[**models::EtlActionFilter**](ETLActionFilter.md)> |  | [optional]
**remote_outbox** | [**models::EtlRemoteOutbox**](ETLRemoteOutbox.md) |  | 
**local_inbox** | [**models::EtlLocalInbox**](ETLLocalInbox.md) |  | 
**jobs** | [**Vec<models::TapisEtlExtendedTapisJobDef>**](TapisETLExtendedTapisJobDef.md) |  | 
**local_outbox** | [**models::EtlLocalOutbox**](ETLLocalOutbox.md) |  | 
**remote_inbox** | [**models::EtlRemoteInbox**](ETLRemoteInbox.md) |  | 
**after** | Option<[**models::EtlActionFilter**](ETLActionFilter.md)> |  | [optional]

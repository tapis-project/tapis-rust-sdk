...
pub async fn create_ci_pipeline(configuration: &configuration::Configuration, group_id: &str, req_ci_pipeline: models::ReqCiPipeline) -> Result<models::RespResourceUrl, Error<CreateCiPipelineError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_group_id = group_id;
    let p_body_req_ci_pipeline = req_ci_pipeline;

    let uri_str = format!("{}/v3/workflows/groups/{group_id}/ci", configuration.base_path, group_id=crate::apis::urlencode(p_path_group_id));

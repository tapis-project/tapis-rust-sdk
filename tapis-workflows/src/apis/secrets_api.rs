...
/// Create a secret. 
pub async fn create_secret(configuration: &configuration::Configuration, req_create_secret: models::ReqCreateSecret) -> Result<models::RespSecret, Error<CreateSecretError>> {
...
pub async fn delete_secret(configuration: &configuration::Configuration, secret_id: &str) -> Result<models::RespString, Error<DeleteSecretError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_secret_id = secret_id;

    let uri_str = format!("{}/v3/workflows/secrets/{secret_id}", configuration.base_path, secret_id=crate::apis::urlencode(p_path_secret_id));
...
/// Retrieve a secret 
pub async fn get_secret(configuration: &configuration::Configuration, secret_id: &str) -> Result<models::RespSecret, Error<GetSecretError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_secret_id = secret_id;
...
pub async fn list_secrets(configuration: &configuration::Configuration, ) -> Result<models::RespSecretList, Error<ListSecretsError>> {

...
pub struct RespSubscriptions {
    ...
    pub result: Option<Vec<models::TapisSubscription>>,
    #[serde(rename = "metadata", skip_serializing_if = "Option::is_none")]
    pub metadata: Option<Box<models::RespSubscriptionsMetadata>>,
}

impl RespSubscriptions {
    pub fn new() -> RespSubscriptions {
        RespSubscriptions {
            status: None,
            message: None,
            version: None,

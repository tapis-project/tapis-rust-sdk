...
/// NewSnapshot : Object with fields that users are allowed to specify for the Snapshot class.
...
impl NewSnapshot {
    ...
    pub fn new(snapshot_id: String, source_volume_id: String, source_volume_path: String) -> NewSnapshot {
        NewSnapshot {
            snapshot_id,
            source_volume_id,
            source_volume_path,

...
/// TemplateTagWithDependents : Template tag with optional dependency information.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct TemplateTagWithDependents {
    ...
    /// Dependency information (only present when include_dependencies=true).
    #[serde(
        rename = "dependents",
        default,
        with = "::serde_with::rust::double_option",
    ...
    pub dependents: Option<Option<Box<models::TemplateTagDependents>>>,
}

impl TemplateTagWithDependents {
    /// Template tag with optional dependency information.
    pub fn new(template_id: String) -> TemplateTagWithDependents {

...
pub async fn create_pod(configuration: &configuration::Configuration, new_pod: models::NewPod) -> Result<models::PodResponse, Error<CreatePodError>> {
...
pub async fn delete_pod(configuration: &configuration::Configuration, pod_id: &str) -> Result<models::PodDeleteResponse, Error<DeletePodError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pod_id = pod_id;

    let uri_str = format!("{}/pods/{pod_id}", configuration.base_path, pod_id=p_path_pod_id.to_string());
...
pub async fn download_from_pod(configuration: &configuration::Configuration, pod_id: &str, url_path: &str, path: Option<&str>) -> Result<serde_json::Value, Error<DownloadFromPodError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pod_id = pod_id;
    let p_path_url_path = url_path;
    let p_query_path = path;

    let uri_str = format!("{}/pods/{pod_id}/download_from_pod{url_path}", configuration.base_path, pod_id=crate::apis::urlencode(p_path_pod_id), url_path=crate::apis::urlencode(p_path_url_path));
...
pub async fn exec_pod_commands(configuration: &configuration::Configuration, pod_id: &str, execute_pod_commands: models::ExecutePodCommands) -> Result<serde_json::Value, Error<ExecPodCommandsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pod_id = pod_id;
    let p_body_execute_pod_commands = execute_pod_commands;

    let uri_str = format!("{}/pods/{pod_id}/exec", configuration.base_path, pod_id=p_path_pod_id.to_string());
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn get_derived_pod(configuration: &configuration::Configuration, pod_id: &str, include_configs: Option<bool>, resolve_secrets: Option<bool>) -> Result<models::PodResponse, Error<GetDerivedPodError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pod_id = pod_id;
    let p_query_include_configs = include_configs;
    let p_query_resolve_secrets = resolve_secrets;

    let uri_str = format!("{}/pods/{pod_id}/derived", configuration.base_path, pod_id=crate::apis::urlencode(p_path_pod_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_pod(configuration: &configuration::Configuration, pod_id: &str, include_configs: Option<bool>, check_unresolved: Option<bool>) -> Result<models::PodResponse, Error<GetPodError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pod_id = pod_id;
    let p_query_include_configs = include_configs;
    let p_query_check_unresolved = check_unresolved;

    let uri_str = format!("{}/pods/{pod_id}", configuration.base_path, pod_id=crate::apis::urlencode(p_path_pod_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_pod_credentials(configuration: &configuration::Configuration, pod_id: &str) -> Result<models::PodCredentialsResponse, Error<GetPodCredentialsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pod_id = pod_id;

    let uri_str = format!("{}/pods/{pod_id}/credentials", configuration.base_path, pod_id=p_path_pod_id.to_string());
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_pod_logs(configuration: &configuration::Configuration, pod_id: &str) -> Result<models::PodLogsResponse, Error<GetPodLogsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pod_id = pod_id;

    let uri_str = format!("{}/pods/{pod_id}/logs", configuration.base_path, pod_id=p_path_pod_id.to_string());
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn list_files_in_pod(configuration: &configuration::Configuration, pod_id: &str, url_path: &str, path: Option<&str>) -> Result<serde_json::Value, Error<ListFilesInPodError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pod_id = pod_id;
    let p_path_url_path = url_path;
    let p_query_path = path;

    let uri_str = format!("{}/pods/{pod_id}/list_files{url_path}", configuration.base_path, pod_id=crate::apis::urlencode(p_path_pod_id), url_path=crate::apis::urlencode(p_path_url_path));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn list_pods(configuration: &configuration::Configuration, ) -> Result<models::PodsResponse, Error<ListPodsError>> {
...
pub async fn pod_auth(configuration: &configuration::Configuration, pod_id_net: &str) -> Result<models::PodResponse, Error<PodAuthError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pod_id_net = pod_id_net;

    let uri_str = format!("{}/pods/{pod_id_net}/auth", configuration.base_path, pod_id_net=p_path_pod_id_net.to_string());
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn pod_auth_callback(configuration: &configuration::Configuration, pod_id_net: &str) -> Result<models::PodResponse, Error<PodAuthCallbackError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pod_id_net = pod_id_net;

    let uri_str = format!("{}/pods/{pod_id_net}/auth/callback", configuration.base_path, pod_id_net=p_path_pod_id_net.to_string());
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn restart_pod(configuration: &configuration::Configuration, pod_id: &str, grab_latest_template_tag: Option<bool>) -> Result<models::PodResponse, Error<RestartPodError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pod_id = pod_id;
    let p_query_grab_latest_template_tag = grab_latest_template_tag;

    let uri_str = format!("{}/pods/{pod_id}/restart", configuration.base_path, pod_id=p_path_pod_id.to_string());
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn save_pod_as_template_tag(configuration: &configuration::Configuration, pod_id_net: &str, new_template_tag_from_pod: models::NewTemplateTagFromPod) -> Result<models::TemplateTagResponse, Error<SavePodAsTemplateTagError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pod_id_net = pod_id_net;
    let p_body_new_template_tag_from_pod = new_template_tag_from_pod;

    let uri_str = format!("{}/pods/{pod_id_net}/save_pod_as_template_tag", configuration.base_path, pod_id_net=p_path_pod_id_net.to_string());
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn start_pod(configuration: &configuration::Configuration, pod_id: &str) -> Result<models::PodResponse, Error<StartPodError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pod_id = pod_id;

    let uri_str = format!("{}/pods/{pod_id}/start", configuration.base_path, pod_id=p_path_pod_id.to_string());
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn stop_pod(configuration: &configuration::Configuration, pod_id: &str) -> Result<models::PodResponse, Error<StopPodError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pod_id = pod_id;

    let uri_str = format!("{}/pods/{pod_id}/stop", configuration.base_path, pod_id=p_path_pod_id.to_string());
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn update_pod(configuration: &configuration::Configuration, pod_id: &str, update_pod: models::UpdatePod) -> Result<models::PodResponse, Error<UpdatePodError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pod_id = pod_id;
...
pub async fn upload_to_pod(configuration: &configuration::Configuration, pod_id: &str, file: std::path::PathBuf, dest_path: &str) -> Result<serde_json::Value, Error<UploadToPodError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pod_id = pod_id;
    let p_form_file = file;
    let p_form_dest_path = dest_path;

    let uri_str = format!("{}/pods/{pod_id}/upload_to_pod", configuration.base_path, pod_id=crate::apis::urlencode(p_path_pod_id));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);

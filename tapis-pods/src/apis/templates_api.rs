...
pub async fn add_template(configuration: &configuration::Configuration, new_template: models::NewTemplate) -> Result<models::TemplateResponse, Error<AddTemplateError>> {
...
pub async fn delete_template(configuration: &configuration::Configuration, template_id: &str) -> Result<models::TemplateDeleteResponse, Error<DeleteTemplateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_template_id = template_id;
...
pub async fn update_template(configuration: &configuration::Configuration, template_id: &str, update_template: models::UpdateTemplate) -> Result<models::TemplateResponse, Error<UpdateTemplateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_template_id = template_id;

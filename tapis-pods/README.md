# Rust API client for tapis_pods
...
Put the package under your project folder in a directory named `tapis_pods` and add the following to `Cargo.toml` under `[dependencies]`:

```
tapis_pods = { path = "./tapis_pods" }
```
...
## Documentation For Models
 ...
 - [ModelsPodsVolumeMount](docs/ModelsPodsVolumeMount.md)
 ...
 - [ModelsTemplatesTagsVolumeMount](docs/ModelsTemplatesTagsVolumeMount.md)

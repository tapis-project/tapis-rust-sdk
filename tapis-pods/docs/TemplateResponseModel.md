...
------------ | ------------- | ------------- | -------------
**template_id** | **String** | Name of template. | 
...
**creation_ts** | Option<**String**> | Time (UTC) that this template was created. | [optional]
**update_ts** | Option<**String**> | Time (UTC) that this template was updated. | [optional]

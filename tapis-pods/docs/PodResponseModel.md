...
**status_container** | Option<[**std::collections::HashMap<String, serde_json::Value>**](serde_json::Value.md)> | Status of container if exists. Gives phase. | [optional][default to {}]

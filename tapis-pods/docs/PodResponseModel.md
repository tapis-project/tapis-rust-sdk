...
**networking** | Option<[**std::collections::HashMap<String, models::ModelsPodsNetworking>**](ModelsPodsNetworking.md)> | Networking information. `{\"url_suffix\": {\"protocol\": \"http\"  \"tcp\", \"port\": int}}` | [optional][default to {default={protocol=http, port=5000}}]
...
**time_to_stop_ts** | Option<**String**> |  | [optional]
...
**start_instance_ts** | Option<**String**> |  | [optional]

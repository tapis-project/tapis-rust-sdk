...
**ephemeral_storage_request** | Option<**i32**> | Ephemeral storage pod requests at startup. In mebibytes (Mi) | [optional][default to -1]
**ephemeral_storage_limit** | Option<**i32**> | Ephemeral storage pod is allowed to use. In mebibytes (Mi) | [optional][default to -1]

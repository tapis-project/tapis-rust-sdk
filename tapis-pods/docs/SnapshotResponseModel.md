...
**creation_ts** | Option<**chrono::DateTime<chrono::FixedOffset>**> | Time (UTC) that this snapshot was created. | [optional]
**update_ts** | Option<**chrono::DateTime<chrono::FixedOffset>**> | Time (UTC) that this snapshot was updated. | [optional]

...
pub async fn create_document(configuration: &configuration::Configuration, db: &str, collection: &str, basic: Option<bool>, body: Option<serde_json::Value>) -> Result<serde_json::Value, Error<CreateDocumentError>> {
...
pub async fn delete_document(configuration: &configuration::Configuration, db: &str, collection: &str, doc_id: &str) -> Result<(), Error<DeleteDocumentError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_db = db;
    let p_path_collection = collection;
    let p_path_doc_id = doc_id;

    let uri_str = format!("{}/meta/{db}/{collection}/{docId}", configuration.base_path, db=crate::apis::urlencode(p_path_db), collection=crate::apis::urlencode(p_path_collection), docId=crate::apis::urlencode(p_path_doc_id));
...
pub async fn get_document(configuration: &configuration::Configuration, db: &str, collection: &str, doc_id: &str) -> Result<serde_json::Value, Error<GetDocumentError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_db = db;
    let p_path_collection = collection;
    let p_path_doc_id = doc_id;
...
pub async fn modify_document(configuration: &configuration::Configuration, db: &str, collection: &str, doc_id: &str, np: Option<bool>, body: Option<serde_json::Value>) -> Result<(), Error<ModifyDocumentError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_db = db;
    let p_path_collection = collection;
    let p_path_doc_id = doc_id;
...
pub async fn replace_document(configuration: &configuration::Configuration, db: &str, collection: &str, doc_id: &str, body: Option<serde_json::Value>) -> Result<(), Error<ReplaceDocumentError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_db = db;
    let p_path_collection = collection;
    let p_path_doc_id = doc_id;

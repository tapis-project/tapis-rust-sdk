...
pub async fn add_aggregation(configuration: &configuration::Configuration, db: &str, collection: &str, aggregation: &str, body: Option<serde_json::Value>) -> Result<(), Error<AddAggregationError>> {
    ...
    let uri_str = format!("{}/meta/{db}/{collection}/_aggr/{aggregation}", configuration.base_path, db=crate::apis::urlencode(p_path_db), collection=crate::apis::urlencode(p_path_collection), aggregation=crate::apis::urlencode(p_path_aggregation));
...
pub async fn delete_aggregation(configuration: &configuration::Configuration, db: &str, collection: &str, aggregation: &str) -> Result<(), Error<DeleteAggregationError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_db = db;
    let p_path_collection = collection;
    let p_path_aggregation = aggregation;
...
pub async fn submit_large_aggregation(configuration: &configuration::Configuration, db: &str, collection: &str, aggregation: &str, page: Option<i32>, pagesize: Option<i32>, keys: Option<Vec<String>>, body: Option<serde_json::Value>) -> Result<serde_json::Value, Error<SubmitLargeAggregationError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_db = db;
    let p_path_collection = collection;
    let p_path_aggregation = aggregation;
...
pub async fn use_aggregation(configuration: &configuration::Configuration, db: &str, collection: &str, aggregation: &str) -> Result<(), Error<UseAggregationError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_db = db;
    let p_path_collection = collection;
    let p_path_aggregation = aggregation;

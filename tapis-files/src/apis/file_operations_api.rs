...
pub async fn delete(configuration: &configuration::Configuration, system_id: &str, path: &str) -> Result<models::FileStringResponse, Error<DeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_system_id = system_id;
    let p_path_path = path;

    let uri_str = format!("{}/v3/files/ops/{systemId}/{path}", configuration.base_path, systemId=crate::apis::urlencode(p_path_system_id), path=crate::apis::urlencode(p_path_path));
...
pub async fn get_facl(configuration: &configuration::Configuration, system_id: &str, path: &str) -> Result<models::NativeLinuxGetFaclResponse, Error<GetFaclError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_system_id = system_id;
    let p_path_path = path;

    let uri_str = format!("{}/v3/files/utils/linux/facl/{systemId}/{path}", configuration.base_path, systemId=crate::apis::urlencode(p_path_system_id), path=crate::apis::urlencode(p_path_path));
...
pub async fn get_stat_info(configuration: &configuration::Configuration, system_id: &str, path: &str, follow_links: Option<bool>) -> Result<models::FileStatInfoResponse, Error<GetStatInfoError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_system_id = system_id;
    let p_path_path = path;
    let p_query_follow_links = follow_links;

    let uri_str = format!("{}/v3/files/utils/linux/{systemId}/{path}", configuration.base_path, systemId=crate::apis::urlencode(p_path_system_id), path=crate::apis::urlencode(p_path_path));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn insert(configuration: &configuration::Configuration, system_id: &str, path: &str, file: std::path::PathBuf) -> Result<models::FileStringResponse, Error<InsertError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_system_id = system_id;
    let p_path_path = path;
...
pub async fn list_files(configuration: &configuration::Configuration, system_id: &str, path: &str, pattern: Option<&str>, limit: Option<i32>, offset: Option<i64>, recurse: Option<bool>, impersonation_id: Option<&str>, shared_ctx: Option<&str>) -> Result<models::FileListingResponse, Error<ListFilesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_system_id = system_id;
    let p_path_path = path;
...
pub async fn mkdir(configuration: &configuration::Configuration, system_id: &str, shared_ctx: Option<&str>, mkdir_request: Option<models::MkdirRequest>) -> Result<models::FileStringResponse, Error<MkdirError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_system_id = system_id;
    let p_query_shared_ctx = shared_ctx;
    let p_body_mkdir_request = mkdir_request;

    let uri_str = format!("{}/v3/files/ops/{systemId}", configuration.base_path, systemId=crate::apis::urlencode(p_path_system_id));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn move_copy(configuration: &configuration::Configuration, system_id: &str, path: &str, move_copy_request: Option<models::MoveCopyRequest>) -> Result<models::FileStringResponse, Error<MoveCopyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_system_id = system_id;
    let p_path_path = path;
...
pub async fn run_linux_native_op(configuration: &configuration::Configuration, system_id: &str, path: &str, recursive: Option<bool>, native_linux_op_request: Option<models::NativeLinuxOpRequest>) -> Result<models::NativeLinuxOpResultResponse, Error<RunLinuxNativeOpError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_system_id = system_id;
    let p_path_path = path;
...
pub async fn set_facl(configuration: &configuration::Configuration, system_id: &str, path: &str, native_linux_set_facl_request: models::NativeLinuxSetFaclRequest) -> Result<models::NativeLinuxSetFaclResponse, Error<SetFaclError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_system_id = system_id;
    let p_path_path = path;

...
**expiration** | Option<**chrono::DateTime<chrono::FixedOffset>**> | The expiration date/time of the PostIt. | [optional]
**created** | Option<**chrono::DateTime<chrono::FixedOffset>**> | Creation timestamp in UTC | [optional]
**updated** | Option<**chrono::DateTime<chrono::FixedOffset>**> | Last update timestamp in UTC | [optional]

...
**custom_idp_configuration** | Option<[**serde_json::Value**](.md)> | JSON-serializable object which includes various configuration details for tenants using an IdP that is not LDAP/AD. | [optional]

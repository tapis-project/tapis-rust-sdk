...
**owner** | Option<**String**> | The username of the user who owns this client. | [optional]
**tenant_id** | Option<**String**> | The tenant this client belongs to. | [optional]
...
**active** | Option<**bool**> | Whether this client is active. Inactive clients cannot be used. | [optional]

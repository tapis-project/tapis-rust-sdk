...
pub async fn get_user_perms(configuration: &configuration::Configuration, app_id: &str, user_name: &str) -> Result<models::RespNameArray, Error<GetUserPermsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_app_id = app_id;
    let p_path_user_name = user_name;

    let uri_str = format!("{}/v3/apps/perms/{appId}/user/{userName}", configuration.base_path, appId=crate::apis::urlencode(p_path_app_id), userName=crate::apis::urlencode(p_path_user_name));
...
pub async fn grant_user_perms(configuration: &configuration::Configuration, app_id: &str, user_name: &str, req_perms: models::ReqPerms) -> Result<models::RespBasic, Error<GrantUserPermsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_app_id = app_id;
    let p_path_user_name = user_name;
...
pub async fn revoke_user_perm(configuration: &configuration::Configuration, app_id: &str, user_name: &str, permission: &str) -> Result<models::RespBasic, Error<RevokeUserPermError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_app_id = app_id;
    let p_path_user_name = user_name;
    let p_path_permission = permission;

    let uri_str = format!("{}/v3/apps/perms/{appId}/user/{userName}/{permission}", configuration.base_path, appId=crate::apis::urlencode(p_path_app_id), userName=crate::apis::urlencode(p_path_user_name), permission=crate::apis::urlencode(p_path_permission));
...
pub async fn revoke_user_perms(configuration: &configuration::Configuration, app_id: &str, user_name: &str, req_perms: models::ReqPerms) -> Result<models::RespBasic, Error<RevokeUserPermsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_app_id = app_id;
    let p_path_user_name = user_name;
    let p_body_req_perms = req_perms;

    let uri_str = format!("{}/v3/apps/perms/{appId}/user/{userName}/revoke", configuration.base_path, appId=crate::apis::urlencode(p_path_app_id), userName=crate::apis::urlencode(p_path_user_name));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);

...
pub async fn change_app_owner(configuration: &configuration::Configuration, app_id: &str, user_name: &str) -> Result<models::RespChangeCount, Error<ChangeAppOwnerError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_app_id = app_id;
    let p_path_user_name = user_name;

    let uri_str = format!("{}/v3/apps/{appId}/changeOwner/{userName}", configuration.base_path, appId=crate::apis::urlencode(p_path_app_id), userName=crate::apis::urlencode(p_path_user_name));
...
pub async fn create_app_version(configuration: &configuration::Configuration, req_post_app: models::ReqPostApp) -> Result<models::RespResourceUrl, Error<CreateAppVersionError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn delete_app(configuration: &configuration::Configuration, app_id: &str) -> Result<models::RespChangeCount, Error<DeleteAppError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_app_id = app_id;

    let uri_str = format!("{}/v3/apps/{appId}/delete", configuration.base_path, appId=crate::apis::urlencode(p_path_app_id));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn disable_app(configuration: &configuration::Configuration, app_id: &str) -> Result<models::RespChangeCount, Error<DisableAppError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_app_id = app_id;

    let uri_str = format!("{}/v3/apps/{appId}/disable", configuration.base_path, appId=crate::apis::urlencode(p_path_app_id));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn disable_app_version(configuration: &configuration::Configuration, app_id: &str, app_version: &str) -> Result<models::RespChangeCount, Error<DisableAppVersionError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_app_id = app_id;
    let p_path_app_version = app_version;

    let uri_str = format!("{}/v3/apps/{appId}/{appVersion}/disable", configuration.base_path, appId=crate::apis::urlencode(p_path_app_id), appVersion=crate::apis::urlencode(p_path_app_version));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn enable_app(configuration: &configuration::Configuration, app_id: &str) -> Result<models::RespChangeCount, Error<EnableAppError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_app_id = app_id;

    let uri_str = format!("{}/v3/apps/{appId}/enable", configuration.base_path, appId=crate::apis::urlencode(p_path_app_id));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn enable_app_version(configuration: &configuration::Configuration, app_id: &str, app_version: &str) -> Result<models::RespChangeCount, Error<EnableAppVersionError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_app_id = app_id;
    let p_path_app_version = app_version;

    let uri_str = format!("{}/v3/apps/{appId}/{appVersion}/enable", configuration.base_path, appId=crate::apis::urlencode(p_path_app_id), appVersion=crate::apis::urlencode(p_path_app_version));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn get_app(configuration: &configuration::Configuration, app_id: &str, app_version: &str, require_exec_perm: Option<bool>, impersonation_id: Option<&str>, select: Option<&str>, resource_tenant: Option<&str>) -> Result<models::RespApp, Error<GetAppError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_app_id = app_id;
    let p_path_app_version = app_version;
    ...
    let uri_str = format!("{}/v3/apps/{appId}/{appVersion}", configuration.base_path, appId=crate::apis::urlencode(p_path_app_id), appVersion=crate::apis::urlencode(p_path_app_version));
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::RespApp`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::RespApp`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn get_app_latest_version(configuration: &configuration::Configuration, app_id: &str, require_exec_perm: Option<bool>, select: Option<&str>, resource_tenant: Option<&str>, impersonation_id: Option<&str>) -> Result<models::RespApp, Error<GetAppLatestVersionError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_app_id = app_id;
    let p_query_require_exec_perm = require_exec_perm;
    let p_query_select = select;
    ...
    let uri_str = format!("{}/v3/apps/{appId}", configuration.base_path, appId=crate::apis::urlencode(p_path_app_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_apps(configuration: &configuration::Configuration, search: Option<&str>, list_type: Option<models::ListTypeEnum>, limit: Option<i32>, order_by: Option<&str>, skip: Option<i32>, start_after: Option<&str>, compute_total: Option<bool>, select: Option<&str>, show_deleted: Option<bool>, impersonation_id: Option<&str>) -> Result<models::RespApps, Error<GetAppsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::RespApps`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::RespApps`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn get_history(configuration: &configuration::Configuration, app_id: &str) -> Result<models::RespAppHistory, Error<GetHistoryError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_app_id = app_id;

    let uri_str = format!("{}/v3/apps/{appId}/history", configuration.base_path, appId=crate::apis::urlencode(p_path_app_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::RespAppHistory`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::RespAppHistory`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn is_enabled(configuration: &configuration::Configuration, app_id: &str, version: Option<&str>) -> Result<models::RespBoolean, Error<IsEnabledError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_app_id = app_id;
    let p_query_version = version;

    let uri_str = format!("{}/v3/apps/{appId}/isEnabled", configuration.base_path, appId=crate::apis::urlencode(p_path_app_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn lock_app(configuration: &configuration::Configuration, app_id: &str, app_version: &str) -> Result<models::RespChangeCount, Error<LockAppError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_app_id = app_id;
    let p_path_app_version = app_version;

    let uri_str = format!("{}/v3/apps/{appId}/{appVersion}/lock", configuration.base_path, appId=crate::apis::urlencode(p_path_app_id), appVersion=crate::apis::urlencode(p_path_app_version));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn patch_app(configuration: &configuration::Configuration, app_id: &str, app_version: &str, req_patch_app: models::ReqPatchApp) -> Result<models::RespResourceUrl, Error<PatchAppError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_app_id = app_id;
    let p_path_app_version = app_version;
...
pub async fn put_app(configuration: &configuration::Configuration, app_id: &str, app_version: &str, req_put_app: models::ReqPutApp) -> Result<models::RespResourceUrl, Error<PutAppError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_app_id = app_id;
    let p_path_app_version = app_version;
...
pub async fn search_apps_query_parameters(configuration: &configuration::Configuration, list_type: Option<models::ListTypeEnum>, limit: Option<i32>, order_by: Option<&str>, skip: Option<i32>, start_after: Option<&str>, compute_total: Option<bool>, select: Option<&str>) -> Result<models::RespApps, Error<SearchAppsQueryParametersError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_list_type = list_type;
    let p_query_limit = limit;
    let p_query_order_by = order_by;
...
pub async fn search_apps_request_body(configuration: &configuration::Configuration, req_search_apps: models::ReqSearchApps, list_type: Option<models::ListTypeEnum>, limit: Option<i32>, order_by: Option<&str>, skip: Option<i32>, start_after: Option<&str>, compute_total: Option<bool>, select: Option<&str>) -> Result<models::RespApps, Error<SearchAppsRequestBodyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn undelete_app(configuration: &configuration::Configuration, app_id: &str) -> Result<models::RespChangeCount, Error<UndeleteAppError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_app_id = app_id;

    let uri_str = format!("{}/v3/apps/{appId}/undelete", configuration.base_path, appId=crate::apis::urlencode(p_path_app_id));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn unlock_app(configuration: &configuration::Configuration, app_id: &str, app_version: &str) -> Result<models::RespChangeCount, Error<UnlockAppError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_app_id = app_id;
    let p_path_app_version = app_version;

    let uri_str = format!("{}/v3/apps/{appId}/{appVersion}/unlock", configuration.base_path, appId=crate::apis::urlencode(p_path_app_id), appVersion=crate::apis::urlencode(p_path_app_version));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);

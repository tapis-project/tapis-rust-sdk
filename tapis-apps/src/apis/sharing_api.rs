...
pub async fn get_share_info(configuration: &configuration::Configuration, app_id: &str) -> Result<models::RespShareInfo, Error<GetShareInfoError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_app_id = app_id;

    let uri_str = format!("{}/v3/apps/share/{appId}", configuration.base_path, appId=crate::apis::urlencode(p_path_app_id));
...
pub async fn share_app(configuration: &configuration::Configuration, app_id: &str, req_share_update: models::ReqShareUpdate) -> Result<models::RespBasic, Error<ShareAppError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_app_id = app_id;
...
pub async fn share_app_public(configuration: &configuration::Configuration, app_id: &str) -> Result<models::RespBasic, Error<ShareAppPublicError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_app_id = app_id;

    let uri_str = format!("{}/v3/apps/share_public/{appId}", configuration.base_path, appId=crate::apis::urlencode(p_path_app_id));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn un_share_app(configuration: &configuration::Configuration, app_id: &str, req_share_update: models::ReqShareUpdate) -> Result<models::RespBasic, Error<UnShareAppError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_app_id = app_id;
    let p_body_req_share_update = req_share_update;

    let uri_str = format!("{}/v3/apps/unshare/{appId}", configuration.base_path, appId=crate::apis::urlencode(p_path_app_id));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn un_share_app_public(configuration: &configuration::Configuration, app_id: &str) -> Result<models::RespBasic, Error<UnShareAppPublicError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_app_id = app_id;

    let uri_str = format!("{}/v3/apps/unshare_public/{appId}", configuration.base_path, appId=crate::apis::urlencode(p_path_app_id));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);

...
**state** | Option<[**serde_json::Value**](.md)> | Current state for the actor. | [optional]
...
**r#type** | Option<**String**> | Return type (none, bin, json) for this actor. Default is none. | [optional]

...
pub struct GetExecutionLogs200Response {
    /// Version of the API
    ...
    pub result: Option<Box<models::ActorExecutionLogs>>,
}

impl GetExecutionLogs200Response {
    pub fn new() -> GetExecutionLogs200Response {

...
pub struct ListExecutions200Response {
    /// Version of the API
    ...
    pub result: Option<Box<models::ActorExecutionSummaries>>,
}

impl ListExecutions200Response {
    pub fn new() -> ListExecutions200Response {

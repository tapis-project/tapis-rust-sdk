...
pub async fn get_admins(configuration: &configuration::Configuration, tenant: &str) -> Result<models::RespNameArray, Error<GetAdminsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_tenant = tenant;

    let uri_str = format!("{}/security/user/admins/{tenant}", configuration.base_path, tenant=crate::apis::urlencode(p_path_tenant));
...
pub async fn get_default_user_role1(configuration: &configuration::Configuration, user: &str) -> Result<models::RespName, Error<GetDefaultUserRole1Error>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_user = user;

    let uri_str = format!("{}/security/user/defaultRole/{user}", configuration.base_path, user=crate::apis::urlencode(p_path_user));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_user_names(configuration: &configuration::Configuration, tenant: Option<&str>) -> Result<models::RespNameArray, Error<GetUserNamesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn get_user_perms(configuration: &configuration::Configuration, user: &str, tenant: Option<&str>, implies: Option<&str>, implied_by: Option<&str>) -> Result<models::RespNameArray, Error<GetUserPermsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_user = user;
    let p_query_tenant = tenant;
    ...
    let uri_str = format!("{}/security/user/perms/{user}", configuration.base_path, user=crate::apis::urlencode(p_path_user));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_user_roles(configuration: &configuration::Configuration, user: &str, tenant: Option<&str>) -> Result<models::RespNameArray, Error<GetUserRolesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_user = user;
    let p_query_tenant = tenant;

    let uri_str = format!("{}/security/user/roles/{user}", configuration.base_path, user=crate::apis::urlencode(p_path_user));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_users_with_permission(configuration: &configuration::Configuration, perm_spec: &str, tenant: Option<&str>) -> Result<models::RespNameArray, Error<GetUsersWithPermissionError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_perm_spec = perm_spec;
    let p_query_tenant = tenant;

    let uri_str = format!("{}/security/user/withPermission/{permSpec}", configuration.base_path, permSpec=crate::apis::urlencode(p_path_perm_spec));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_users_with_role(configuration: &configuration::Configuration, role_name: &str, tenant: Option<&str>, role_type: Option<models::RoleTypeEnum>) -> Result<models::RespNameArray, Error<GetUsersWithRoleError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_role_name = role_name;
    let p_query_tenant = tenant;
    let p_query_role_type = role_type;

    let uri_str = format!("{}/security/user/withRole/{roleName}", configuration.base_path, roleName=crate::apis::urlencode(p_path_role_name));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn grant_role(configuration: &configuration::Configuration, req_grant_role: models::ReqGrantRole) -> Result<models::RespChangeCount, Error<GrantRoleError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn grant_role_with_permission(configuration: &configuration::Configuration, req_grant_role_with_permission: models::ReqGrantRoleWithPermission) -> Result<models::RespChangeCount, Error<GrantRoleWithPermissionError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_req_grant_role_with_permission = req_grant_role_with_permission;

    let uri_str = format!("{}/security/user/grantRoleWithPerm", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn grant_user_permission(configuration: &configuration::Configuration, req_grant_user_permission: models::ReqGrantUserPermission) -> Result<models::RespChangeCount, Error<GrantUserPermissionError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_req_grant_user_permission = req_grant_user_permission;

    let uri_str = format!("{}/security/user/grantUserPermission", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn has_role(configuration: &configuration::Configuration, req_user_has_role: models::ReqUserHasRole) -> Result<models::RespAuthorized, Error<HasRoleError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn has_role_all(configuration: &configuration::Configuration, req_user_has_role_multi: models::ReqUserHasRoleMulti) -> Result<models::RespAuthorized, Error<HasRoleAllError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn has_role_any(configuration: &configuration::Configuration, req_user_has_role_multi: models::ReqUserHasRoleMulti) -> Result<models::RespAuthorized, Error<HasRoleAnyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_req_user_has_role_multi = req_user_has_role_multi;
...
pub async fn is_admin(configuration: &configuration::Configuration, req_user_is_admin: models::ReqUserIsAdmin) -> Result<models::RespAuthorized, Error<IsAdminError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn is_permitted(configuration: &configuration::Configuration, req_user_is_permitted: models::ReqUserIsPermitted) -> Result<models::RespAuthorized, Error<IsPermittedError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn is_permitted_all(configuration: &configuration::Configuration, req_user_is_permitted_multi: models::ReqUserIsPermittedMulti) -> Result<models::RespAuthorized, Error<IsPermittedAllError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn is_permitted_any(configuration: &configuration::Configuration, req_user_is_permitted_multi: models::ReqUserIsPermittedMulti) -> Result<models::RespAuthorized, Error<IsPermittedAnyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_req_user_is_permitted_multi = req_user_is_permitted_multi;
...
pub async fn revoke_role(configuration: &configuration::Configuration, req_revoke_role: models::ReqRevokeRole) -> Result<models::RespChangeCount, Error<RevokeRoleError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn revoke_user_permission(configuration: &configuration::Configuration, req_revoke_user_permission: models::ReqRevokeUserPermission) -> Result<models::RespChangeCount, Error<RevokeUserPermissionError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_req_revoke_user_permission = req_revoke_user_permission;

    let uri_str = format!("{}/security/user/revokeUserPermission", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);

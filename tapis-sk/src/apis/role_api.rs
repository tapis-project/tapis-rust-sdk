...
pub async fn add_child_role(configuration: &configuration::Configuration, req_add_child_role: models::ReqAddChildRole) -> Result<models::RespChangeCount, Error<AddChildRoleError>> {
...
pub async fn add_role_permission(configuration: &configuration::Configuration, req_add_role_permission: models::ReqAddRolePermission) -> Result<models::RespChangeCount, Error<AddRolePermissionError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn create_role(configuration: &configuration::Configuration, req_create_role: models::ReqCreateRole) -> Result<models::RespResourceUrl, Error<CreateRoleError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn delete_role_by_name(configuration: &configuration::Configuration, role_name: &str, tenant: Option<&str>, role_type: Option<models::RoleTypeEnum>) -> Result<models::RespChangeCount, Error<DeleteRoleByNameError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_role_name = role_name;
    let p_query_tenant = tenant;
    let p_query_role_type = role_type;

    let uri_str = format!("{}/security/role/{roleName}", configuration.base_path, roleName=crate::apis::urlencode(p_path_role_name));
...
pub async fn get_default_user_role(configuration: &configuration::Configuration, user: &str) -> Result<models::RespName, Error<GetDefaultUserRoleError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_user = user;

    let uri_str = format!("{}/security/role/defaultRole/{user}", configuration.base_path, user=crate::apis::urlencode(p_path_user));
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::RespName`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::RespName`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn get_role_by_name(configuration: &configuration::Configuration, role_name: &str, tenant: Option<&str>, role_type: Option<models::RoleTypeEnum>) -> Result<models::RespRole, Error<GetRoleByNameError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_role_name = role_name;
    let p_query_tenant = tenant;
    let p_query_role_type = role_type;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::RespRole`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::RespRole`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn get_role_names(configuration: &configuration::Configuration, tenant: Option<&str>, role_type: Option<models::RoleTypeEnum>) -> Result<models::RespNameArray, Error<GetRoleNamesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_tenant = tenant;
    let p_query_role_type = role_type;
...
pub async fn get_role_permissions(configuration: &configuration::Configuration, role_name: &str, tenant: Option<&str>, immediate: Option<bool>) -> Result<models::RespNameArray, Error<GetRolePermissionsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_role_name = role_name;
    let p_query_tenant = tenant;
    let p_query_immediate = immediate;

    let uri_str = format!("{}/security/role/{roleName}/perms", configuration.base_path, roleName=crate::apis::urlencode(p_path_role_name));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn preview_path_prefix(configuration: &configuration::Configuration, req_preview_path_prefix: models::ReqPreviewPathPrefix) -> Result<models::RespPathPrefixes, Error<PreviewPathPrefixError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_req_preview_path_prefix = req_preview_path_prefix;

    let uri_str = format!("{}/security/role/previewPathPrefix", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::RespPathPrefixes`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::RespPathPrefixes`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn remove_child_role(configuration: &configuration::Configuration, req_remove_child_role: models::ReqRemoveChildRole) -> Result<models::RespChangeCount, Error<RemoveChildRoleError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn remove_path_permission_from_all_roles(configuration: &configuration::Configuration, req_remove_permission_from_all_roles: models::ReqRemovePermissionFromAllRoles) -> Result<models::RespChangeCount, Error<RemovePathPermissionFromAllRolesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_req_remove_permission_from_all_roles = req_remove_permission_from_all_roles;

    let uri_str = format!("{}/security/role/removePathPermFromAllRoles", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<RemovePathPermissionFromAllRolesError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn remove_permission_from_all_roles(configuration: &configuration::Configuration, req_remove_permission_from_all_roles: models::ReqRemovePermissionFromAllRoles) -> Result<models::RespChangeCount, Error<RemovePermissionFromAllRolesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_req_remove_permission_from_all_roles = req_remove_permission_from_all_roles;

    let uri_str = format!("{}/security/role/removePermFromAllRoles", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn remove_role_permission(configuration: &configuration::Configuration, req_remove_role_permission: models::ReqRemoveRolePermission) -> Result<models::RespChangeCount, Error<RemoveRolePermissionError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn replace_path_prefix(configuration: &configuration::Configuration, req_replace_path_prefix: models::ReqReplacePathPrefix) -> Result<models::RespChangeCount, Error<ReplacePathPrefixError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_req_replace_path_prefix = req_replace_path_prefix;

    let uri_str = format!("{}/security/role/replacePathPrefix", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn role_permits(configuration: &configuration::Configuration, role_name: &str, req_role_permits: models::ReqRolePermits, immediate: Option<bool>) -> Result<models::RespAuthorized, Error<RolePermitsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_role_name = role_name;
    let p_body_req_role_permits = req_role_permits;
    let p_query_immediate = immediate;

    let uri_str = format!("{}/security/role/{roleName}/permits", configuration.base_path, roleName=crate::apis::urlencode(p_path_role_name));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn update_role_description(configuration: &configuration::Configuration, role_name: &str, req_update_role_description: models::ReqUpdateRoleDescription) -> Result<models::RespBasic, Error<UpdateRoleDescriptionError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_role_name = role_name;
    let p_body_req_update_role_description = req_update_role_description;

    let uri_str = format!("{}/security/role/updateDesc/{roleName}", configuration.base_path, roleName=crate::apis::urlencode(p_path_role_name));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn update_role_name(configuration: &configuration::Configuration, role_name: &str, req_update_role_name: models::ReqUpdateRoleName) -> Result<models::RespBasic, Error<UpdateRoleNameError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_role_name = role_name;
    let p_body_req_update_role_name = req_update_role_name;

    let uri_str = format!("{}/security/role/updateName/{roleName}", configuration.base_path, roleName=crate::apis::urlencode(p_path_role_name));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn update_role_owner(configuration: &configuration::Configuration, role_name: &str, req_update_role_owner: models::ReqUpdateRoleOwner) -> Result<models::RespBasic, Error<UpdateRoleOwnerError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_role_name = role_name;
    let p_body_req_update_role_owner = req_update_role_owner;

    let uri_str = format!("{}/security/role/updateOwner/{roleName}", configuration.base_path, roleName=crate::apis::urlencode(p_path_role_name));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);

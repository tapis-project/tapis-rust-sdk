...
pub async fn delete_share(configuration: &configuration::Configuration, grantor: Option<&str>, grantee: Option<&str>, tenant: Option<&str>, resource_type: Option<&str>, resource_id1: Option<&str>, resource_id2: Option<&str>, privilege: Option<&str>) -> Result<models::RespChangeCount, Error<DeleteShareError>> {
...
pub async fn delete_share_by_id(configuration: &configuration::Configuration, id: i32, tenant: Option<&str>) -> Result<models::RespChangeCount, Error<DeleteShareByIdError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
    let p_query_tenant = tenant;

    let uri_str = format!("{}/security/share/{id}", configuration.base_path, id=p_path_id);
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn get_share(configuration: &configuration::Configuration, id: i32, tenant: Option<&str>) -> Result<models::RespShare, Error<GetShareError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
    let p_query_tenant = tenant;
...
pub async fn get_shares(configuration: &configuration::Configuration, grantor: Option<&str>, grantee: Option<&str>, tenant: Option<&str>, resource_type: Option<&str>, resource_id1: Option<&str>, resource_id2: Option<&str>, privilege: Option<&str>, created_by: Option<&str>, created_by_tenant: Option<&str>, include_public_grantees: Option<bool>, require_null_id2: Option<bool>, id: Option<i32>) -> Result<models::RespShareList, Error<GetSharesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_grantor = grantor;
    let p_query_grantee = grantee;
    let p_query_tenant = tenant;
...
pub async fn has_privilege(configuration: &configuration::Configuration, grantee: Option<&str>, tenant: Option<&str>, resource_type: Option<&str>, resource_id1: Option<&str>, resource_id2: Option<&str>, privilege: Option<&str>, exclude_public: Option<bool>, exclude_public_no_authn: Option<bool>) -> Result<models::RespBoolean, Error<HasPrivilegeError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_grantee = grantee;
    let p_query_tenant = tenant;
    let p_query_resource_type = resource_type;
...
pub async fn share_resource(configuration: &configuration::Configuration, req_share_resource: models::ReqShareResource) -> Result<models::RespResourceUrl, Error<ShareResourceError>> {
    // add a prefix to parameters to efficiently prevent name collisions

...
pub async fn delete_secret(configuration: &configuration::Configuration, secret_type: &str, secret_name: &str, req_versions: models::ReqVersions, sysid: Option<&str>, sysuser: Option<&str>, keytype: Option<&str>, dbhost: Option<&str>, dbname: Option<&str>, dbservice: Option<&str>) -> Result<models::RespVersions, Error<DeleteSecretError>> {
    ...
    let uri_str = format!("{}/security/vault/secret/delete/{secretType}/{secretName}", configuration.base_path, secretType=crate::apis::urlencode(p_path_secret_type), secretName=crate::apis::urlencode(p_path_secret_name));
...
pub async fn destroy_secret(configuration: &configuration::Configuration, secret_type: &str, secret_name: &str, req_versions: models::ReqVersions, sysid: Option<&str>, sysuser: Option<&str>, keytype: Option<&str>, dbhost: Option<&str>, dbname: Option<&str>, dbservice: Option<&str>) -> Result<models::RespVersions, Error<DestroySecretError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_secret_type = secret_type;
    let p_path_secret_name = secret_name;
    let p_body_req_versions = req_versions;
    ...
    let uri_str = format!("{}/security/vault/secret/destroy/{secretType}/{secretName}", configuration.base_path, secretType=crate::apis::urlencode(p_path_secret_type), secretName=crate::apis::urlencode(p_path_secret_name));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn destroy_secret_meta(configuration: &configuration::Configuration, secret_type: &str, secret_name: &str, tenant: Option<&str>, user: Option<&str>, sysid: Option<&str>, sysuser: Option<&str>, keytype: Option<&str>, dbhost: Option<&str>, dbname: Option<&str>, dbservice: Option<&str>) -> Result<models::RespBasic, Error<DestroySecretMetaError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_secret_type = secret_type;
    let p_path_secret_name = secret_name;
    ...
    let uri_str = format!("{}/security/vault/secret/destroy/meta/{secretType}/{secretName}", configuration.base_path, secretType=crate::apis::urlencode(p_path_secret_type), secretName=crate::apis::urlencode(p_path_secret_name));
...
pub async fn list_secret_meta(configuration: &configuration::Configuration, secret_type: &str, tenant: Option<&str>, user: Option<&str>, sysid: Option<&str>, sysuser: Option<&str>, keytype: Option<&str>, dbhost: Option<&str>, dbname: Option<&str>, dbservice: Option<&str>) -> Result<models::RespSecretList, Error<ListSecretMetaError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_secret_type = secret_type;
    let p_query_tenant = tenant;
    let p_query_user = user;
    ...
    let uri_str = format!("{}/security/vault/secret/list/meta/{secretType}", configuration.base_path, secretType=crate::apis::urlencode(p_path_secret_type));
...
pub async fn read_secret(configuration: &configuration::Configuration, secret_type: &str, secret_name: &str, tenant: Option<&str>, user: Option<&str>, version: Option<i32>, sysid: Option<&str>, sysuser: Option<&str>, keytype: Option<&str>, dbhost: Option<&str>, dbname: Option<&str>, dbservice: Option<&str>) -> Result<models::RespSecret, Error<ReadSecretError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_secret_type = secret_type;
    let p_path_secret_name = secret_name;
    let p_query_tenant = tenant;
    ...
    let uri_str = format!("{}/security/vault/secret/{secretType}/{secretName}", configuration.base_path, secretType=crate::apis::urlencode(p_path_secret_type), secretName=crate::apis::urlencode(p_path_secret_name));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn read_secret_meta(configuration: &configuration::Configuration, secret_type: &str, secret_name: &str, tenant: Option<&str>, user: Option<&str>, sysid: Option<&str>, sysuser: Option<&str>, keytype: Option<&str>, dbhost: Option<&str>, dbname: Option<&str>, dbservice: Option<&str>) -> Result<models::RespSecretVersionMetadata, Error<ReadSecretMetaError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_secret_type = secret_type;
    let p_path_secret_name = secret_name;
    let p_query_tenant = tenant;
    ...
    let uri_str = format!("{}/security/vault/secret/read/meta/{secretType}/{secretName}", configuration.base_path, secretType=crate::apis::urlencode(p_path_secret_type), secretName=crate::apis::urlencode(p_path_secret_name));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn undelete_secret(configuration: &configuration::Configuration, secret_type: &str, secret_name: &str, req_versions: models::ReqVersions, sysid: Option<&str>, sysuser: Option<&str>, keytype: Option<&str>, dbhost: Option<&str>, dbname: Option<&str>, dbservice: Option<&str>) -> Result<models::RespVersions, Error<UndeleteSecretError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_secret_type = secret_type;
    let p_path_secret_name = secret_name;
    let p_body_req_versions = req_versions;
    ...
    let uri_str = format!("{}/security/vault/secret/undelete/{secretType}/{secretName}", configuration.base_path, secretType=crate::apis::urlencode(p_path_secret_type), secretName=crate::apis::urlencode(p_path_secret_name));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn validate_service_password(configuration: &configuration::Configuration, secret_name: &str, req_validate_pwd: models::ReqValidatePwd) -> Result<models::RespAuthorized, Error<ValidateServicePasswordError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_secret_name = secret_name;
    let p_body_req_validate_pwd = req_validate_pwd;

    let uri_str = format!("{}/security/vault/secret/validateServicePassword/{secretName}", configuration.base_path, secretName=crate::apis::urlencode(p_path_secret_name));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn validate_site_admin_password(configuration: &configuration::Configuration, secret_name: &str, req_validate_pwd: models::ReqValidatePwd) -> Result<models::RespAuthorized, Error<ValidateSiteAdminPasswordError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_secret_name = secret_name;
    let p_body_req_validate_pwd = req_validate_pwd;

    let uri_str = format!("{}/security/vault/secret/validateSiteAdminPassword/{secretName}", configuration.base_path, secretName=crate::apis::urlencode(p_path_secret_name));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn write_secret(configuration: &configuration::Configuration, secret_type: &str, secret_name: &str, req_write_secret: models::ReqWriteSecret, sysid: Option<&str>, sysuser: Option<&str>, keytype: Option<&str>, dbhost: Option<&str>, dbname: Option<&str>, dbservice: Option<&str>) -> Result<models::RespSecretMeta, Error<WriteSecretError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_secret_type = secret_type;
    let p_path_secret_name = secret_name;

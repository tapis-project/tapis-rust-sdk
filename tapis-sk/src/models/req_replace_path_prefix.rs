...
pub struct ReqReplacePathPrefix {
    #[serde(rename = "tenant")]
    pub tenant: String,
    #[serde(rename = "schema")]
    pub schema: String,
...
impl ReqReplacePathPrefix {
    pub fn new(tenant: String, schema: String, old_system_id: String, new_system_id: String) -> ReqReplacePathPrefix {

...
pub struct RespSecretVersionMetadata {
    ...
    pub result: Option<Box<models::SkSecretVersionMetadata>>,
}

impl RespSecretVersionMetadata {
    pub fn new() -> RespSecretVersionMetadata {

...
pub async fn cancel_transfer_task(configuration: &configuration::Configuration, client_id: &str, task_id: &str, access_token: &str, refresh_token: &str) -> Result<models::RespCancelTask, Error<CancelTransferTaskError>> {
    ...
    let uri_str = format!("{}/v3/globus-proxy/transfers/{client_id}/{task_id}", configuration.base_path, client_id=crate::apis::urlencode(p_path_client_id), task_id=crate::apis::urlencode(p_path_task_id));
...
pub async fn create_transfer_task(configuration: &configuration::Configuration, client_id: &str, access_token: &str, refresh_token: &str, req_create_transfer: Option<models::ReqCreateTransfer>) -> Result<models::RespTransferTask, Error<CreateTransferTaskError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_client_id = client_id;
    let p_query_access_token = access_token;
    let p_query_refresh_token = refresh_token;
    ...
    let uri_str = format!("{}/v3/globus-proxy/transfers/{client_id}", configuration.base_path, client_id=crate::apis::urlencode(p_path_client_id));
...
pub async fn get_transfer_task(configuration: &configuration::Configuration, client_id: &str, task_id: &str, access_token: &str, refresh_token: &str) -> Result<models::RespTransferTask, Error<GetTransferTaskError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_client_id = client_id;
    let p_path_task_id = task_id;
    let p_query_access_token = access_token;

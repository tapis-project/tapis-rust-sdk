...
pub async fn change_system_owner(configuration: &configuration::Configuration, system_id: &str, user_name: &str) -> Result<models::RespChangeCount, Error<ChangeSystemOwnerError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_system_id = system_id;
    let p_path_user_name = user_name;

    let uri_str = format!("{}/v3/systems/{systemId}/changeOwner/{userName}", configuration.base_path, systemId=crate::apis::urlencode(p_path_system_id), userName=crate::apis::urlencode(p_path_user_name));
...
pub async fn create_system(configuration: &configuration::Configuration, req_post_system: models::ReqPostSystem, skip_credential_check: Option<bool>) -> Result<models::RespResourceUrl, Error<CreateSystemError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn delete_system(configuration: &configuration::Configuration, system_id: &str) -> Result<models::RespChangeCount, Error<DeleteSystemError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_system_id = system_id;

    let uri_str = format!("{}/v3/systems/{systemId}/delete", configuration.base_path, systemId=crate::apis::urlencode(p_path_system_id));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn disable_system(configuration: &configuration::Configuration, system_id: &str) -> Result<models::RespChangeCount, Error<DisableSystemError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_system_id = system_id;

    let uri_str = format!("{}/v3/systems/{systemId}/disable", configuration.base_path, systemId=crate::apis::urlencode(p_path_system_id));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn enable_system(configuration: &configuration::Configuration, system_id: &str) -> Result<models::RespChangeCount, Error<EnableSystemError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_system_id = system_id;

    let uri_str = format!("{}/v3/systems/{systemId}/enable", configuration.base_path, systemId=crate::apis::urlencode(p_path_system_id));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn get_history(configuration: &configuration::Configuration, system_id: &str) -> Result<models::RespSystemHistory, Error<GetHistoryError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_system_id = system_id;

    let uri_str = format!("{}/v3/systems/{systemId}/history", configuration.base_path, systemId=crate::apis::urlencode(p_path_system_id));
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::RespSystemHistory`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::RespSystemHistory`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn get_system(configuration: &configuration::Configuration, system_id: &str, authn_method: Option<&str>, require_exec_perm: Option<bool>, select: Option<&str>, return_credentials: Option<bool>, impersonation_id: Option<&str>, shared_app_ctx: Option<&str>, resource_tenant: Option<&str>) -> Result<models::RespSystem, Error<GetSystemError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_system_id = system_id;
    ...
    let uri_str = format!("{}/v3/systems/{systemId}", configuration.base_path, systemId=crate::apis::urlencode(p_path_system_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::RespSystem`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::RespSystem`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn get_systems(configuration: &configuration::Configuration, search: Option<&str>, list_type: Option<models::ListTypeEnum>, limit: Option<i32>, order_by: Option<&str>, skip: Option<i32>, start_after: Option<&str>, compute_total: Option<bool>, select: Option<&str>, show_deleted: Option<bool>, impersonation_id: Option<&str>, has_credentials: Option<bool>) -> Result<models::RespSystems, Error<GetSystemsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::RespSystems`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::RespSystems`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn host_eval(configuration: &configuration::Configuration, system_id: &str, env_var_name: &str) -> Result<models::RespName, Error<HostEvalError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_system_id = system_id;
    let p_path_env_var_name = env_var_name;

    let uri_str = format!("{}/v3/systems/{systemId}/hostEval/{envVarName}", configuration.base_path, systemId=crate::apis::urlencode(p_path_system_id), envVarName=crate::apis::urlencode(p_path_env_var_name));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn is_enabled(configuration: &configuration::Configuration, system_id: &str) -> Result<models::RespBoolean, Error<IsEnabledError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_system_id = system_id;

    let uri_str = format!("{}/v3/systems/{systemId}/isEnabled", configuration.base_path, systemId=crate::apis::urlencode(p_path_system_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn match_constraints(configuration: &configuration::Configuration, req_match_constraints: models::ReqMatchConstraints) -> Result<models::RespSystems, Error<MatchConstraintsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn patch_system(configuration: &configuration::Configuration, system_id: &str, req_patch_system: models::ReqPatchSystem) -> Result<models::RespResourceUrl, Error<PatchSystemError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_system_id = system_id;
...
pub async fn put_system(configuration: &configuration::Configuration, system_id: &str, req_put_system: models::ReqPutSystem, skip_credential_check: Option<bool>) -> Result<models::RespResourceUrl, Error<PutSystemError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_system_id = system_id;
...
pub async fn search_systems_query_parameters(configuration: &configuration::Configuration, free_form_parameter_name: Option<std::collections::HashMap<String, String>>, list_type: Option<models::ListTypeEnum>, limit: Option<i32>, order_by: Option<&str>, skip: Option<i32>, start_after: Option<&str>, compute_total: Option<bool>, select: Option<&str>, has_credentials: Option<bool>) -> Result<models::RespSystems, Error<SearchSystemsQueryParametersError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn search_systems_request_body(configuration: &configuration::Configuration, req_search_systems: models::ReqSearchSystems, list_type: Option<models::ListTypeEnum>, limit: Option<i32>, order_by: Option<&str>, skip: Option<i32>, start_after: Option<&str>, compute_total: Option<bool>, select: Option<&str>, has_credentials: Option<bool>) -> Result<models::RespSystems, Error<SearchSystemsRequestBodyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn undelete_system(configuration: &configuration::Configuration, system_id: &str) -> Result<models::RespChangeCount, Error<UndeleteSystemError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_system_id = system_id;

    let uri_str = format!("{}/v3/systems/{systemId}/undelete", configuration.base_path, systemId=crate::apis::urlencode(p_path_system_id));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);

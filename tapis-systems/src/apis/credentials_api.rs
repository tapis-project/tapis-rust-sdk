...
pub async fn check_user_credential(configuration: &configuration::Configuration, system_id: &str, user_name: &str, authn_method: Option<&str>) -> Result<models::RespBasic, Error<CheckUserCredentialError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_system_id = system_id;
    let p_path_user_name = user_name;
    let p_query_authn_method = authn_method;

    let uri_str = format!("{}/v3/systems/credential/{systemId}/user/{userName}/check", configuration.base_path, systemId=crate::apis::urlencode(p_path_system_id), userName=crate::apis::urlencode(p_path_user_name));
...
pub async fn create_user_credential(configuration: &configuration::Configuration, system_id: &str, user_name: &str, req_update_credential: models::ReqUpdateCredential, create_tms_keys: Option<bool>, skip_credential_check: Option<bool>) -> Result<models::RespBasic, Error<CreateUserCredentialError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_system_id = system_id;
    let p_path_user_name = user_name;
    ...
    let uri_str = format!("{}/v3/systems/credential/{systemId}/user/{userName}", configuration.base_path, systemId=crate::apis::urlencode(p_path_system_id), userName=crate::apis::urlencode(p_path_user_name));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn generate_globus_tokens(configuration: &configuration::Configuration, system_id: &str, user_name: &str, auth_code: &str, session_id: &str) -> Result<models::RespBasic, Error<GenerateGlobusTokensError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_system_id = system_id;
    let p_path_user_name = user_name;
    ...
    let uri_str = format!("{}/v3/systems/credential/{systemId}/user/{userName}/globus/tokens/{authCode}/{sessionId}", configuration.base_path, systemId=crate::apis::urlencode(p_path_system_id), userName=crate::apis::urlencode(p_path_user_name), authCode=crate::apis::urlencode(p_path_auth_code), sessionId=crate::apis::urlencode(p_path_session_id));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn get_globus_auth_url(configuration: &configuration::Configuration, system_id: &str) -> Result<models::RespGlobusAuthUrl, Error<GetGlobusAuthUrlError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_system_id = system_id;

    let uri_str = format!("{}/v3/systems/credential/{systemId}/globus/authUrl", configuration.base_path, systemId=crate::apis::urlencode(p_path_system_id));
...
pub async fn get_user_credential(configuration: &configuration::Configuration, system_id: &str, user_name: &str, authn_method: Option<&str>) -> Result<models::RespCredential, Error<GetUserCredentialError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_system_id = system_id;
    let p_path_user_name = user_name;
    let p_query_authn_method = authn_method;
...
pub async fn remove_user_credential(configuration: &configuration::Configuration, system_id: &str, user_name: &str) -> Result<models::RespBasic, Error<RemoveUserCredentialError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_system_id = system_id;
    let p_path_user_name = user_name;

...
------------- | ------------- | -------------
[**get_user_perms**](PermissionsApi.md#get_user_perms) | **GET** /v3/systems/perms/{systemId}/user/{userName} | 
[**grant_user_perms**](PermissionsApi.md#grant_user_perms) | **POST** /v3/systems/perms/{systemId}/user/{userName} | 
[**revoke_user_perm**](PermissionsApi.md#revoke_user_perm) | **DELETE** /v3/systems/perms/{systemId}/user/{userName}/{permission} | 
[**revoke_user_perms**](PermissionsApi.md#revoke_user_perms) | **POST** /v3/systems/perms/{systemId}/user/{userName}/revoke | 



## get_user_perms

> models::RespNameArray get_user_perms(system_id, user_name)
...
> models::RespBasic grant_user_perms(system_id, user_name, req_perms)
...
> models::RespBasic revoke_user_perm(system_id, user_name, permission)
...
> models::RespBasic revoke_user_perms(system_id, user_name, req_perms)

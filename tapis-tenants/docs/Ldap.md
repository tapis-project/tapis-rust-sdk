...
------------ | ------------- | ------------- | -------------
**ldap_id** | Option<**String**> | Unique id for the LDAP object. | [optional]
**url** | Option<**String**> | url to the LDAP | [optional]
**port** | Option<**i32**> | port for the LDAP | [optional]
**use_ssl** | Option<**bool**> | Whether to use SSL with the LDAP | [optional]

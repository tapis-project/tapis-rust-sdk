...
pub async fn cancel_job(
...
) -> Result<models::RespCancelJob, Error<CancelJobError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::RespCancelJob`"))),
            ContentType::Unsupported(unknown_type) => Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::RespCancelJob`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn get_job(
    configuration: &configuration::Configuration,
    job_uuid: &str,
) -> Result<models::RespGetJob, Error<GetJobError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_job_uuid = job_uuid;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::RespGetJob`"))),
            ContentType::Unsupported(unknown_type) => Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::RespGetJob`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn get_job_history(
    ...
    limit: Option<i32>,
    skip: Option<i32>,
) -> Result<models::RespJobHistory, Error<GetJobHistoryError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_job_uuid = job_uuid;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::RespJobHistory`"))),
            ContentType::Unsupported(unknown_type) => Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::RespJobHistory`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn get_job_list(
...
) -> Result<models::RespGetJobList, Error<GetJobListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_limit = limit;
    let p_query_skip = skip;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::RespGetJobList`"))),
            ContentType::Unsupported(unknown_type) => Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::RespGetJobList`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn get_job_output_download(
...
) -> Result<reqwest::Response, Error<GetJobOutputDownloadError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_job_uuid = job_uuid;
    ...
    let uri_str = format!(
        ...
        configuration.base_path,
        jobUuid = crate::apis::urlencode(p_path_job_uuid),
        outputPath = crate::apis::urlencode(p_path_output_path)
    );
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_job_output_list(
    ...
    skip: Option<i32>,
    allow_if_running: Option<bool>,
) -> Result<models::RespGetJobOutputList, Error<GetJobOutputListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_job_uuid = job_uuid;
    let p_path_output_path = output_path;
    let p_query_limit = limit;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::RespGetJobOutputList`"))),
            ContentType::Unsupported(unknown_type) => Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::RespGetJobOutputList`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn get_job_search_list(
    ...
    select: Option<&str>,
    list_type: Option<&str>,
) -> Result<models::RespJobSearchAllAttributes, Error<GetJobSearchListError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_limit = limit;
    let p_query_skip = skip;
    let p_query_start_after = start_after;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::RespJobSearchAllAttributes`"))),
            ContentType::Unsupported(unknown_type) => Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::RespJobSearchAllAttributes`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn get_job_search_list_by_post_sql_str(
    ...
    list_type: Option<&str>,
    body: Option<serde_json::Value>,
) -> Result<models::RespJobSearchAllAttributes, Error<GetJobSearchListByPostSqlStrError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_limit = limit;
    let p_query_skip = skip;
    let p_query_start_after = start_after;
...
pub async fn get_job_status(
    configuration: &configuration::Configuration,
    job_uuid: &str,
) -> Result<models::RespGetJobStatus, Error<GetJobStatusError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_job_uuid = job_uuid;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::RespGetJobStatus`"))),
            ContentType::Unsupported(unknown_type) => Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::RespGetJobStatus`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn get_resubmit_request_json(
    configuration: &configuration::Configuration,
    job_uuid: &str,
) -> Result<models::RespGetResubmit, Error<GetResubmitRequestJsonError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_job_uuid = job_uuid;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::RespGetResubmit`"))),
            ContentType::Unsupported(unknown_type) => Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::RespGetResubmit`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn hide_job(
    ...
    job_uuid: &str,
    body: Option<serde_json::Value>,
) -> Result<models::RespHideJob, Error<HideJobError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_job_uuid = job_uuid;
    let p_body_body = body;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::RespHideJob`"))),
            ContentType::Unsupported(unknown_type) => Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::RespHideJob`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn patch_job_annotations(
...
) -> Result<models::RespJobAnnotations, Error<PatchJobAnnotationsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_job_uuid = job_uuid;
    let p_body_req_job_annotation = req_job_annotation;

    let uri_str = format!(
        "{}/jobs/{jobUuid}/annotations",
        configuration.base_path,
        jobUuid = crate::apis::urlencode(p_path_job_uuid)
    );
    let mut req_builder = configuration
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::RespJobAnnotations`"))),
            ContentType::Unsupported(unknown_type) => Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::RespJobAnnotations`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn put_job_annotations(
    ...
    job_uuid: &str,
    req_job_annotation: models::ReqJobAnnotation,
) -> Result<models::RespJobAnnotations, Error<PutJobAnnotationsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_job_uuid = job_uuid;
    let p_body_req_job_annotation = req_job_annotation;
...
pub async fn resubmit_job(
    ...
    job_uuid: &str,
    body: Option<serde_json::Value>,
) -> Result<models::RespSubmitJob, Error<ResubmitJobError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_job_uuid = job_uuid;
    let p_body_body = body;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::RespSubmitJob`"))),
            ContentType::Unsupported(unknown_type) => Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::RespSubmitJob`")))),
        }
    } else {
        let content = resp.text().await?;
...
) -> Result<models::RespBasic, Error<SendEventError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_job_uuid = job_uuid;
...
) -> Result<models::RespSubmitJob, Error<SubmitJobError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn unhide_job(
    ...
    job_uuid: &str,
    body: Option<serde_json::Value>,
) -> Result<models::RespHideJob, Error<UnhideJobError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_job_uuid = job_uuid;
    let p_body_body = body;

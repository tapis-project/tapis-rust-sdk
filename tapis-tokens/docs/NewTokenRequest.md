...
------------ | ------------- | ------------- | -------------
**account_type** | **AccountType** | The type of account (user or service) represented by the token. (enum: user, service) | 
...
**claims** | Option<**serde_json::Value**> | JSON object of additional claims to add to the standard claims issued with the token. Note - standard claims cannot be modified through this parameter. | [optional]
